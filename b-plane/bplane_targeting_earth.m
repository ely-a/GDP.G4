...
for k = 1:num_angles
    ...
    r_sc_earth = [-1.4868e8 -1.2094e7 -5.4385e6] - [-1.4922e8 -1.0510e7 -4.5364e6];
    v_sc_earth = -[4.4412 -36.5465 -17.0892] + [1.567 -27.3629 -11.8613];
    mu = 398600;
    v_inf_mag = 10.881197003;
    result = bplane(r_sc_earth, v_sc_earth, mu, thetaB_deg);
    vinf_in = v_sc_earth; % km/s

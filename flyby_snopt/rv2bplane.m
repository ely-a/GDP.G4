function [bplane, rv, tv, ibperr] = rv2bplane(mu, r, v)

% convert body-centered inertial cartesian position
% and velocity vectors to b-plane coordinates

% input

%  mu = gravitational constant (kilometer^3/second^2)
...
%  bplane(7)  = b dot t (kilometers)
%  bplane(8)  = b dot r (kilometers)
...
% hyperbolic speed (kilometers/second)
...
% perapsis radius of hyperbola (kilometers)

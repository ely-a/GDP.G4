% REQUIRED ADD-ONS
% type "aeroDataPackage" into the command window and get thttps://bb.imperial.ac.uk/webapps/portal/execute/tabs/tabAction?tab_tab_group_id=_1_1he planetary data
...
% iterate lambert's problem to getg graphs
...
initial_v_inf = 11; % km/s
sequence = [2, 4, 7]; % 1 = Venus --> 7 = Neptune
max_lengths = [3000, 5000]; % transfer times (days)
